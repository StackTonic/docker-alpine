...
ENV REL=v3.17
ENV ARCH=x86_64
ENV MIRROR_OLD=mirror.aarnet.edu.au/pub
ENV MIRROR_NEW=https://mirror.aarnet.edu.au/pub/alpine/
ENV MIRROR=${MIRROR_NEW}
...
xz
# Set Mirror
RUN sed -i "s~dl-cdn.alpinelinux.org~${MIRROR_OLD}~" /etc/apk/repositories
